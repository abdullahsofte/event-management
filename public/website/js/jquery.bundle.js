    ...
    (r.prototype = {
        ...
        fit: function (t) {
            var i,
                ...
                e = t.length,
                o = e > 0 ? t[0].h : 0;
            for (this.root.h = o, i = 0; i < e; i++)
                (n = t[i]),
                    (r = this.findNode(this.root, n.w, n.h))
                        ? (n.fit = this.splitNode(r, n.w, n.h))
        ...
        growDown: function (t, i) {
            ...
            return (
                ...
                (r = this.findNode(this.root, t, i))
                    ? this.splitNode(r, t, i)
                    : null
            );
        },
    }),
        ...
        (i.fn.filterizr.prototype = {
            init: function (t, r) {
                ...
                return (
                    ...
                    (n._activeArray = n._getCollectionByFilter(
                        n.options.filter
                    )),
            ...
            search: function (t) {
                ...
                if (i._isSearchActivated())
                    for (e = 0; e < r.length; e++)
                        r[e].text().toLowerCase().indexOf(t.toLowerCase()) >
                            -1 && n.push(r[e]);
                if (n.length > 0) i._handleFiltering(n);
                else if (i._isSearchActivated())
                    for (e = 0; e < i._activeArray.length; e++)
            ...
            sort: function (t, i) {
                ...
                var e = r._multifilterModeOn()
                    ? r._makeMultifilterArray()
                    : r._getCollectionByFilter(r.options.filter);
                r._isSearchActivated()
                    ? r.search(r._typedText)
                    : r._placeItems(e);
            },
            ...
            _makeSubarrays: function () {
                ...
                for (r = 0; r < t._mainArray.length; r++)
                    if ("object" == typeof t._mainArray[r]._category)
                        for (
                            var n = t._mainArray[r]._category.length, e = 0;
                            e < n;
                            e++
                        )
                            i[t._mainArray[r]._category[e] - 1].push(
                                t._mainArray[r]
                            );
                ...
                i(t).resize(function () {
                    ...
                    r
                        ...
                        .on("shufflingStart", function () {
                            (r._isShuffling = !0),
                                r.options.callbacks.onShufflingStart();
                        })
                        .on("shufflingEnd", function () {
                            r.options.callbacks.onShufflingEnd(),
                                (r._isShuffling = !1);
                        })
                        .on("sortingStart", function () {
                            (r._isSorting = !0),
                                r.options.callbacks.onSortingStart();
                        })
                        .on("sortingEnd", function () {
                            r.options.callbacks.onSortingEnd(),
                                (r._isSorting = !1);
                        });
            },
            _calcItemPositions: function () {
                var t = this,
                    ...
                    e = 0,
                    o = Math.round(
                        t.width() / t.find(".filtr-item").outerWidth()
                    ),
                    a = 0,
                    s = n[0].outerWidth(),
                    l = 0,
                ...
                if ("packed" === t.options.layout) {
                    ...
                    for (h.fit(t._activeArray), c = 0; c < n.length; c++)
                        _.push({ left: n[c].fit.x, top: n[c].fit.y });
                    e = h.root.h;
                }
                if ("horizontal" === t.options.layout)
                    for (a = 1, c = 1; c <= n.length; c++)
                        (s = n[c - 1].outerWidth()),
                            (l = n[c - 1].outerHeight()),
                            _.push({ left: f, top: u }),
                            (f += s),
            ...
            _handleFiltering: function (t) {
                for (
                    var i = this,
                        r = i._getArrayOfUniqueItems(i._activeArray, t),
                        n = 0;
                    n < r.length;
                    n++
                )
            ...
            _placeItems: function (t) {
                var i = this;
                (i._isAnimating = !0),
                    (i._itemPositions = i._calcItemPositions());
        ...
        _onTransitionEnd: function () {
            ...
            t._filteringOut
                ? (i(t).addClass("filteredOut"),
                  ...
                  (t._filteringOut = !1))
                : t._filteringIn &&
                  ((t._isFilteredOut = !1), (t._filteringIn = !1)),
...
!(function (e) {
    e.fn.ColorPanel = function (a) {
        ...
        var l = n.colors || null;
        l &&
            (e.each(l, function (a, l) {
                var s = e("<li/>"),
                    i = e("<a />", { href: l, class: n.linkClass }).css(
                        "background-color",
                        a
                    );
            ...
            e("ul", t).on("click", "a", function (a) {
                ...
                n.animateContainer
                    ? e(n.animateContainer).fadeOut(function () {
                          e(n.styleSheet).attr("href", t),
                              e("html, body").animate({ scrollTop: 0 }, 600),
                              e(".site-header").removeClass("has-fixed"),
                              e(this).delay(1e3).fadeIn();
                      })
                    : e(n.styleSheet).attr("href", t);
            }));
    };
