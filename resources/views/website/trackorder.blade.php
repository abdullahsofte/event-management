    ...
    <div class="container">
        <div class="row">
            <div class="banner_title d-flex py-2">
                <p class="text-black m-0 p-0"><a href="{{ route('home') }}">Home</a> / Order Tracking Page</p>
            </div>
                        ...
                        <article class="card">
                            <div class="card-body row">
                                <div class="col-md-2 col-6">
                                    <strong>Order No:</strong> <br> {{ $order->invoice_no }}
                                </div>
                                <div class="col-md-2 col-6"> <strong>Order Date:</strong> <br>{{ $order->created_at }} </div>
                                <div class="col-md-3 col-6"> <strong>Contact Info:</strong> <br> <i class="fa fa-phone"></i> {{ $order->customer_mobile }}</div>
                                <div class="col-md-2 col-6"> <strong>Status:</strong> <br> Picked by the courier </div>
                                <div class="col-md-3 col-6 text-lg-end"> <strong>Total: </strong> <br>৳{{ number_format($order->total_amount, 2) }} </div>
                            </div>
                        </article>
                        <div class="track">
                            @if($order->status == 'p')
                                ...
                                <div class="step">
                                    <span class="icon"> <i class="fa-solid fa-hand-lizard"></i> </span>
                                    <span class="text">Delivered</span>
                                </div>
                            @elseif($order->status == 'on')
                                <div class="step active">
                                    <span class="icon"> <i class="fa fa-spinner"></i> </span>
                                    <span class="text">Order Pending</span>
                                    <small class="text-danger">{{ $order->order_date }}</small>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered table-hover text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td><img src="{{ asset($item->product->image) }}" width="30" height="30" alt=""></td>
