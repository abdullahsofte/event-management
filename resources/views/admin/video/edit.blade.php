                ...
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <div class="card">
                            ...
                            <form action="{{ route('video-gallery.update', $video) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control my-form-control @error('youtube_link') is-invalid @enderror"  name="youtube_link" id="" cols="30" rows="4">{{ $video->youtube_link }}</textarea>
