...
<main class="mb-5">
   <div class="container ">
    <div class="heading-title p-2 my-2">
        <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="">Home</a> > Add News And Event</span>
    </div>
       <div class="row">
           <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="table-head"><i class="fas fa-cogs me-1"></i>News And Event</div>
                    </div>
             ...
             <div class="col-12">
               <div class="card"> 
                <div class="card-header">
                    <div class="table-head"><i class="fas fa-table me-1"></i>News And Event List</div>
                </div>
                <div class="card-body table-card-body p-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('event.edit', $item->id) }}" class="btn btn-edit"><i class="fas fa-pencil-alt"></i></a>
