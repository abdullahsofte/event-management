...
{{-- 
                            ...
                            <div class="col-md-3">
                                <strong><label>Map</label> <span class="float-right">:</span></strong>
                            </div>
                            <div class="col-md-9">
                                <textarea rows="4"  class="form-control @error('map') is-invalid @enderror " name="map" >{!! $company->map !!}
                                </textarea>
                                @error('map')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                            ...
                            {{-- <div class="col-md-3">
                                <strong><label>Footer Content</label> <span class="float-right">:</span></strong>
                            </div>
                            <div class="col-md-9">
                                <textarea rows="4"  class="form-control @error('slogan') is-invalid @enderror " name="slogan" >{!! $company->slogan !!}
                                </textarea>
                                @error('slogan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
