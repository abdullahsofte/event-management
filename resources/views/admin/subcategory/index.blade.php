    ...
    <main>
        <div class="container ">
            <div class="heading-title p-2 my-2">
                <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="">Home</a> > Service Subcategory</span>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="table-head"><i class="fas fa-cogs me-1"></i>Service Subcategory Entry</div>
                        </div>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="table-head"><i class="fas fa-table me-1"></i>Service Subcategory List <a href=""
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('subcategory.destroy', $item) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
