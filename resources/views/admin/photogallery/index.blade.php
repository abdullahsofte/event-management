                            ...
                            <form action="{{ route('photo-gallery.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button type="submit" name="submit" class="btn btn-sm btn-primary float-right mt-2" value="Submit">upload</button>
                                    </div>
                                </div>
                            </form>
                        </div>     
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="submit" class="btn btn-delete" onclick="deleteUser({{ $item->id }})"><i class="far fa-trash-alt"></i></button>
                                                        <form id="delete-form-{{ $item->id }}" action="{{ route('photo-gallery.delete', $item) }}"
