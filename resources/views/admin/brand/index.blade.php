...
<main class="mb-5">
   <div class="container ">
    <div class="heading-title p-2 my-2">
        <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="">Home</a> > Add Brand</span>
    </div>
       <div class="row">
           <div class="col-5">
                <div class="card">
                    <div class="card-header">
                        <div class="table-head"><i class="fas fa-cogs me-1"></i>Brand Form</div>
                    </div>
                        ...
                        <form action="{{ route('brand.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    {{-- <input type="checkbox" name="is_popular" value="1" title="Is Popular">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td class="text-center"><img src="{{asset($item->image)}}" alt="" style="height: 60px; width:60px"></td>
                                {{-- <td>@if ($item->is_popular == '1')
                                    Popular
                                   @endif 
                               </td> --}}
                              <td class="text-center">
                                    <a href="{{ route('brand.edit', $item->id) }}" class="btn btn-edit"><i class="fas fa-pencil-alt"></i></a>
